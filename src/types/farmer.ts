...
export interface FarmerMetadata {
  type: "farmer";
  version?: string;
  company: { name: string; owner?: Record<string, any>; address?: Record<string, any> };
  farmer: { id: string; name: string; nik: string; age: number; gender: string; address?: Record<string, any> };
  name?: string;
  description?: string;
  image?: string;
...
export const FARMER_NFT_ABI = [
  ...
  // --- Roles / AccessControl (public constants + helpers) ---
  { inputs: [], name: "DEFAULT_ADMIN_ROLE", outputs: [{ internalType: "bytes32", name: "", type: "bytes32" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "COMPANY_OWNER_ROLE", outputs: [{ internalType: "bytes32", name: "", type: "bytes32" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "address", name: "newAdmin", type: "address" }], name: "grantAdminRole", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ internalType: "address", name: "oldAdmin", type: "address" }], name: "revokeAdminRole", outputs: [], stateMutability: "nonpayable", type: "function" },
